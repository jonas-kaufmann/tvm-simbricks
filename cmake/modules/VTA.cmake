...
elseif(PYTHON)
  ...
  if(USE_VTA_FPGA)
    ...
    elseif(${VTA_TARGET} STREQUAL "simbricks-pci")
      tvm_file_glob(GLOB SIMBRICKS_PCI_SRC ${VTA_HW_PATH}/src/simbricks-pci/*.cc)
      tvm_file_glob(GLOB CMA_MALLOC_SRC 3rdparty/cma_malloc/userspace/src/*.c)
      list(APPEND FPGA_RUNTIME_SRCS ${SIMBRICKS_PCI_SRC})
      list(APPEND FPGA_RUNTIME_SRCS ${CMA_MALLOC_SRC})
    endif()
    # Target lib: vta
    ...
    elseif(${VTA_TARGET} STREQUAL "simbricks-pci")
      target_include_directories(vta SYSTEM PUBLIC ${VTA_HW_PATH}/src/simbricks-pci)
      target_include_directories(vta PUBLIC 3rdparty)
      target_include_directories(vta PUBLIC 3rdparty/cma_malloc)
      target_include_directories(vta PUBLIC 3rdparty/cma_malloc/userspace/inc)
    endif()
  endif()
